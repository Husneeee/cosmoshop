...
export const DashboardMenu = () => {
	...
	return (
		<Navbar expand="lg" className="bg-danger-subtle mb-3">
			<Container fluid>
				...
				>
					<Offcanvas.Header closeButton className="bg-secondary-subtle">
						<Offcanvas.Title id="dashboard-menu-label" className="text-danger ">
							Dashboard
						</Offcanvas.Title>
					</Offcanvas.Header>
					<Offcanvas.Body className="bg-danger-subtle">
